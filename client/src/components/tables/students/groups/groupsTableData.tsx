  ...
  return (
    <div className="mx-10">
      <div className="flex items-center py-4">
        <Input
          placeholder="Filter Group-Numbers..."
          value={handleValueChange(table.getColumn("groupNum")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("groupNum")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
